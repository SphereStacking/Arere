...
import type { Action, ActionDefinition } from '@/domain/action/types'
import { registerTranslations } from '@/infrastructure/i18n/index'
import { ActionLoadError } from '@/shared/utils/error'
