...
See [TUI Control API](/en/2.api/3.tui-control) for details.
...
See the [GitHub Actions Integration Guide](/en/1.guides/06.github-actions/01.overview) for details.
...
See the [i18n Guide](/en/1.guides/07.i18n-guide) for details.

---

## Next Steps

- [Tutorials](/en/1.guides/02.tutorials) - Learn step by step
- [defineAction API](/en/2.api/1.defineAction) - Action definition details
- [Prompt API](/en/2.api/2.prompt) - Getting user input
- [Control API](/en/2.api/3.tui-control) - Progress display and timing control
- [Shell Executor](/en/2.api/4.shell) - Executing shell commands
- [GitHub Actions Integration](/en/1.guides/06.github-actions/01.overview) - Use in CI/CD
- [Plugin Development Guide](/en/1.guides/04.plugins/02.creating) - How to create plugins
- [i18n Guide](/en/1.guides/07.i18n-guide) - Internationalization details
