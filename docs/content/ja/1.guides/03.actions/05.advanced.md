...
詳細は [TUI Control API](/ja/api/tui-control) を参照してください。
...
詳細は [GitHub Actions統合ガイド](/ja/guides/github-actions-integration) を参照してください。
...
詳細は [i18nガイド](/ja/guides/i18n-guide) を参照してください。

---

## 次のステップ

- [実践チュートリアル](/ja/guides/tutorials) - ステップバイステップで学ぶ
- [defineAction API](/ja/api/defineAction) - アクション定義の詳細
- [Prompt API](/ja/api/prompt) - ユーザー入力の取得
- [Control API](/ja/api/tui-control) - 進捗表示とタイミング制御
- [Shell Executor](/ja/api/shell) - シェルコマンドの実行
- [GitHub Actions統合](/ja/guides/github-actions-integration) - CI/CDで使う
- [プラグイン開発ガイド](/ja/guides/developing-plugins) - プラグインの作成方法
- [i18nガイド](/ja/guides/i18n-guide) - 国際化の詳細
