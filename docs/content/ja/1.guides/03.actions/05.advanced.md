...
詳細は [TUI Control API](/ja/2.api/3.tui-control) を参照してください。
...
詳細は [GitHub Actions統合ガイド](/ja/1.guides/06.github-actions/01.overview) を参照してください。
...
詳細は [i18nガイド](/ja/1.guides/07.i18n-guide) を参照してください。

---

## 次のステップ

- [チュートリアル](/ja/1.guides/02.tutorials) - ステップバイステップで学ぶ
- [defineAction API](/ja/2.api/1.defineAction) - アクション定義の詳細
- [Prompt API](/ja/2.api/2.prompt) - ユーザー入力の取得
- [Control API](/ja/2.api/3.tui-control) - 進捗表示とタイミング制御
- [Shell Executor](/ja/2.api/4.shell) - シェルコマンドの実行
- [GitHub Actions統合](/ja/1.guides/06.github-actions/01.overview) - CI/CDで使う
- [プラグイン開発ガイド](/ja/1.guides/04.plugins/02.creating) - プラグインの作成方法
- [i18nガイド](/ja/1.guides/07.i18n-guide) - 国際化の詳細
