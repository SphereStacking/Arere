...
**注意:** TUIからアクションが実行される場合のみ利用可能です。ヘッドレスモードではエラーをスローします。
...
spinner/progressを使用する前に、常にターミナルがインタラクティブかチェックします：
...
- [Prompt vs Control API ガイド](../guides/prompt-vs-control-api.md) - どのAPIをいつ使うべきか
